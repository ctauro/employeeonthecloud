...
import com.clarence.employeeonthecloud.controller.Controller;
...
privileged aspect Controller_Roo_Controller {
    ...
    public String Controller.create(@Valid Employee employee, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String Controller.update(@Valid Employee employee, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, employee);
    ...
    void Controller.populateEditForm(Model uiModel, Employee employee) {
